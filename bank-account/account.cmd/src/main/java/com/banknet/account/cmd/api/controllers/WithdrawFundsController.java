...
import com.banknet.account.cmd.api.commands.DepositFundsCommand;
import com.banknet.account.cmd.api.commands.WithdrawFundsCommand;
...
public class WithdrawFundsController {
    ...
    public ResponseEntity<BaseResponse> withdrawFunds(@PathVariable(value = "id") String id,
        ...
        try {
            ...
            var safeErrorMessage = MessageFormat.format("Error while processing request to withdraw funds from Bank Account ID {0}", id);
